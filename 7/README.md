...
### 5.1. График ускорения и эффективности для p = 1
![График для одного процесса](ОТЧЕТ/images/speedup_p1.png)

### 5.2. График ускорения и эффективности для p = 4
![График для 4 процессов](ОТЧЕТ/images/speedup_p4.png)

### 5.3. График ускорения и эффективности для p = 8
![График для 8 процессов](ОТЧЕТ/images/speedup_p8.png)

### 5.4. График ускорения и эффективности для p = 16
![График для 16 процессов](ОТЧЕТ/images/speedup_p16.png)
