...
![График времени выполнения](7/ОТЧЕТ/images/execution_time.png)

### 5.2. График ускорения
![График ускорения](7/ОТЧЕТ/images/speedup.png)

### 5.3. График эффективности
![График эффективности](7/ОТЧЕТ/images/efficiency.png)
